    ...
    <main>
      <section class="course-detail-hero">
        <div class="container">
          ...
          <h1>{{ $t('courses.corsoBase.title') }}</h1>
          <p class="course-detail-hero__desc">{{ $t('courses.corsoBase.description') }}</p>
        ...
        <div class="container course-detail-layout">
          ...
          <div class="course-main">
            ...
            <div class="course-faq">
              <h2>FAQ</h2>
              <details
                v-for="(item, i) in (tm('courses.corsoBase.faq') as any[])"
                :key="i"
              >
          ...
          <aside class="course-sidebar">
            <div class="course-sidebar__card">
              ...
              <NuxtLink :to="localePath('/checkout/introduzione-bitcoin')" class="book-button" style="display:block; text-align:center; text-decoration:none;">
                {{ $t('courses.buyButton') }}
              </NuxtLink>
            </div>
          </aside>
      ...
      <section class="course-detail-cta">
        <div class="container" style="text-align:center; padding: 3rem 0;">
          <NuxtLink :to="localePath('/checkout/introduzione-bitcoin')" class="book-button" style="display:inline-block; text-decoration:none; font-size:1.1rem; padding: 1rem 2.5rem;">
            {{ $t('courses.buyButton') }}
          </NuxtLink>
        </div>
      </section>
...
const course = courses.find(c => c.slug === 'corso-base')!
...
useHead({
  title: () => `${t('courses.corsoBase.title')} | ${t('seo.title')}`,
  meta: [
    { name: 'description', content: () => t('courses.corsoBase.description') },
    { property: 'og:title', content: () => `${t('courses.corsoBase.title')} | ${t('seo.title')}` },
    { property: 'og:description', content: () => t('courses.corsoBase.description') },
    { property: 'og:url', content: 'https://robertocedolin.com/courses/corso-base' },
  ],
})
</script>
